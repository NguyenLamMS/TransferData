...
//
//public class adapterChooseContact extends ArrayAdapter<item> {
//
...
//
//    public adapterChooseContact(@NonNull Context context, int resource, @NonNull ArrayList<item> objects) {
...
//        if(it.img_resource != -1) img_item.setImageResource(it.img_resource);
//        else img_item.setImageDrawable(it.getImgDrawable());
